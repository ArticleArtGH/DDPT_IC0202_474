...
--Чтение, Добавление, Обновление, Удаление, Исполнение

--таблицы
grant select on Companies to rEmployee_ARCs
go
grant select on Services to rEmployee_ARCs
go
grant select, insert, update, delete on Customer to rEmployee_ARCs
go
grant select, insert, update, delete on Contract to rEmployee_ARCs
go
--представления
grant select on CompaniesTheirServices to rEmployee_ARCs 
go
grant select on TermsOfWorkOfCompanies to rEmployee_ARCs
go
grant select on TermsRepairsDays to rEmployee_ARCs
go
grant select on CountEachServices to rEmployee_ARCs
go
--процедуры
grant exec on inputDataCustomer to rEmployee_ARCs
go
grant exec on inputDataContract to rEmployee_ARCs
go

--Резервное копирование БД

grant backup database, backup log to rEmployee_ARCs
go
...
--резервное копироваине БД
grant backup database, backup log to rManager_ARCs
with grant option--возможность выдавать другим эту возможность
go
